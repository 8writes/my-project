  ...
  return (
    <div className='about-us flex flex-wrap justify-center gap-10 px-5 md:px-10 lg:px-28 pt-11 md:pb-10'>
      <motion.div
        ...
        <h1 className='font-extrabold pb-10 tracking-wide  text-slate-800 text-3xl md:text-4xl'>
      ...
      <motion.div
        ...
        <p className='text-slate-800 text-base tracking-wide  pt-3 font-medium'>
