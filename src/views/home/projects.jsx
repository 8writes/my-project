      ...
      <div className='flex flex-wrap w-full'>
        <div className='w-full lg:flex-1 relative group '>
          ...
          <div className='absolute top-60 px-4'>
            <h1 className='lg:group-hover:-translate-y-10 delay-100 ease-in-out lg:group-hover:text-white transition-all lg:translate-y-10 lg:text-transparent text-white font-bold py-10 text-2xl uppercase'>
        ...
        <div className='w-full lg:flex-1  relative group '>
          ...
          />
          <div className='absolute top-60 px-4'>
            <h1 className='group-hover:-translate-y-10 delay-100 ease-in-out group-hover:text-white transition-all lg:translate-y-10 lg:text-transparent text-white font-bold py-10 text-2xl uppercase'>
              Fencing for Niger Delta Power Holding Company designated staff
              estate Gbarain Power Station Bayelsa.
            </h1>
          </div>
