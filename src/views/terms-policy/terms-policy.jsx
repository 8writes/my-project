  ...
  return (
    <div className='about bg-white pt-16 lg:pt-20'>
      ...
      <div className='text-slate-800 p-5 pb-40 md:p-24'>
        <p className='pb-10'>Last updated: January 06, 2019.</p>
        <p className='pb-10'>
          Please read these terms and conditions carefully before using Our
          Service.
        </p>

        <h2 className='pb-5'>Interpretation and Definitions</h2>

        <h3 className='pb-4'>Interpretation</h3>
        <p className='pb-4'>
        ...
        <p className='pb-4'>For the purposes of these Terms and Conditions:</p>
        <ul>
          <li className='py-4'>
          ...
          <li className='py-4'>
            ...
            "Us," or "Our" in this Agreement) refers to On-point Dynamics
            Synergy, 132 Woji Road GRA Phase II, Port Harcourt, Rivers State.
          </li>
          <li className='py-4'>
          ...
          <li className='py-4'>
            <strong>Website</strong> refers to On-point Dynamics Synergy,
            accessible from{' '}
            <a href='https://www.onpointdynamicssynergy.com/'>
              https://www.onpointdynamicssynergy.com/
            </a>
          </li>
          <li className='py-4'>
        ...
        <h2 className='py-4'>Acknowledgment</h2>
        <p className='pb-4'>
        ...
        <h2 className='py-4'>Termination</h2>
        <p className='py-4'>
        ...
        <h2 className='py-4'>"AS IS" and "AS AVAILABLE" Disclaimer</h2>
        <p className='py-4'>
          The Service is provided to You "AS IS" and "AS AVAILABLE" and with all
          faults and defects without warranty of any kind. To the maximum extent
          permitted under applicable law, the Company, on its own behalf and on
          behalf of its Affiliates and their respective licensors and service
        ...
        <h2 className='py-4'>Disputes Resolution</h2>
        <p className='py-4'>
          If You have any concern or dispute about the Service, You agree to
          first try to resolve the dispute informally by contacting the Company.
        </p>

        <h2 className='py-4'>Severability and Waiver</h2>

        <h3 className='py-4'>Severability</h3>
        <p className='py-4'>
        ...
        <h2 className='py-4'>Translation Interpretation</h2>
        <p className='py-4'>
        ...
        <h2 className='py-4'>Changes to These Terms and Conditions</h2>
        <p className='py-4'>
        ...
        <ul className='py-10'>
          <li>
            By email:{' '}
            <a href='mailto:onpointsynergyltd@gmail.com'>
              onpointsynergyltd@gmail.com
            </a>
          </li>
          <li>
