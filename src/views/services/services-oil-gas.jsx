    ...
    <div className='pt-16 lg:pt-20'>
      ...
      <ServicesContent image={image5}>
        ...
        <p className='text-slate-800 pt-5 pb-2 leading-9 tracking-wide'>
          ...
          spill equipment on a rental basis in support of oil & gas exploration
          activities around the globe and operate a number of major response
          facilities located in Nigeria. The response bases are fully equipped
          with industry best practice response equipment, personnel, and
          training facilities. ON-POINT DYNAMICS SYNERGY LIMITED also operates
          across the entirety of Nigeria where it is the largest commercial
          provider of oil spill services and a leading provider of environmental
        ...
        <ol className='text-slate-800 ml-5 pt-5 pb-2 leading-9 list-decimal tracking-wide'>
          ...
          <li>Maintenance dredging of oil well locations accesses and slots</li>
          <li>Canalization</li>
          <li>
            Channeling and creek improvement for oil rigs and vessel passages
          </li>
          <li>Sand fill reclamation for infrastructural development</li>
          <li>
            Sand stockpiling for earth reclamation of land locations and access
            Roads
          </li>
        </ol>
        ...
        <ol className='text-slate-800 ml-5 pt-5 pb-2 leading-9 list-decimal tracking-wide'>
          ...
          <li>Pay loaders</li>
          <li>
            Bulldozers and Trucks to oil, oil service and construction
            companies.
          </li>
        </ol>
        ...
        <p className='text-slate-800 pb-2 leading-9 tracking-wide'>
          ...
          and supply, Oil and Gas companies can heighten their preparedness and
          prevent spill incidents from occurring. Our company today represents a
          major manufacturer from France Efinor Sea Cleaner, they have the best
          patented technology in responding to oil spill both offshore and
          onshore. The BP spill afforded them the opportunity to showcase their
        ...
        <ol className='text-slate-800 ml-5 pt-5 pb-2 leading-9 list-decimal tracking-wide'>
          ...
          <li>
            Establishment & Management of Oil Spill Response Centres & Teams
          </li>
          <li>Equipment Rental</li>
          <li>Response Exercise Design</li>
          <li>Delivery & Evaluation</li>
          <li>Plan Development, Review & Management</li>
          <li>Gap Analysis & Preparedness Audits</li>
          <li>Risk Assessment & Facility Inspection</li>
          <li>Associated Waste Handling</li>
          <li>Transportation & Disposal</li>
        </ol>
        ...
        <p className='text-slate-800 pb-2 leading-9 tracking-wide'>
          ...
          to allow inspection of tanks and vessel internals including
          infrastructure. Thereafter, where applicable, we undertake the surface
          preparation and recoating to protect internals from corrosion thereby
        ...
        <p className='text-slate-800 pb-2 leading-9 tracking-wide'>
          ...
          working on projects in the Oil and Gas industry (offshore and onshore)
          in Nigeria. This means prolonging the life and integrity of industrial
          assets (a rig for example) with no impact on operations. We've
          engineered the necessary safe systems of work into our procedures and
          our personnel are trained to the highest standard to provide our
          clients with safe, cost effective and responsible solutions.
        </p>
        ...
        <p className='text-slate-800 pb-2 leading-9 tracking-wide'>
          ...
          beach erosion therefore protecting your piece of precious property.
        </p>
      </ServicesContent>
    </div>
  )
