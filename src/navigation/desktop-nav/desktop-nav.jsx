    ...
    <div className='hidden lg:block fixed w-full z-50'>
      <section className='desktop-nav flex items-center justify-between border-b-2 border-slate-200 bg-white p-1'>
        ...
        <div className='desktop-nav-end  mx-auto'>
          <button className='font-medium border-x-2 border-t-2 border-transparent bg-blue-400 px-10 py-4 text-white uppercase hover:bg-white hover:shadow-2xl hover:text-blue-400 hover:border-slate-200 scale-95 hover:scale-100 transition-all'>
            Contact
          </button>
        </div>
      </section>
